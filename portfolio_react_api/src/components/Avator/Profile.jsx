...
const ProfileTitle = () => {
  return (
    <div>
      ...
      <h1 className="mt-4 text-3xl font-bold text-blue-700">MD Eyakub Sorkar</h1>
      ...
      <div className="mt-5 leading-none">
        <span className="text-xs address_span">
        ...
        <span className="text-xs text-blue-600"><svg className="h-auto w-4 inline" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
